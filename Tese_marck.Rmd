...
df_geral$MF_GERAL <- df_geral %>% select(159:161) %>% rowMeans()
```
...
df_principal <- df_geral %>% select(4,10,120,123,136,140:145,153:162)
...
```{r}
modP1 <- lm(Autoridade_P ~ MF1 + MF2 + MF3, df_principal_join)
summary(modP1)

mod1 <- lm(Autoridade ~ MF1 + MF2 + MF3, df_principal_join)
summary(mod1)
```
